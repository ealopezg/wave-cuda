...
void schroedinger_(float ***grid, int N, int i, int j, int t)
{
    ...
    case 0:
        ...
        break;
    case 1:
        grid[i][j][0] = grid[i][j][1] + (0.00125 * (grid[i + 1][j][1] + grid[i - 1][j][1] + grid[i][j - 1][1] + grid[i][j + 1][1] - (4 * grid[i][j][1])));
        break;
    default:
        grid[i][j][0] = (2 * grid[i][j][1]) - grid[i][j][2] + (0.0025 * (grid[i + 1][j][1] + grid[i - 1][j][1] + grid[i][j - 1][1] + grid[i][j + 1][1] - (4 * grid[i][j][1])));
        break;
    }
}
